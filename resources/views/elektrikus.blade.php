                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item trending_cat"><a class="nav-link" data-toggle="tab" href="#woman" role="tab">Woman</a></li>
                                <li class="nav-item trending_cat"><a class="nav-link" data-toggle="tab" href="#kids" role="tab">Kids</a></li>
                                <li class="nav-item trending_cat"><a class="nav-link" data-toggle="tab" href="#accessories" role="tab">Accessories</a></li>
                                <li class="nav-item trending_cat"><a class="nav-link" data-toggle="tab" href="#essential" role="tab">Essential</a></li>
                                <li class="nav-item trending_cat"><a class="nav-link" data-toggle="tab" href="#prices" role="tab">Prices</a></li>
                            </ul>
                            <!--/ End Tab Nav -->
                        </div>
                                    ...
                                    <div class="row" id="trending_change">
                                        ...
                                        @if(isset($trendingProducts))
                                            @foreach($trendingProducts as $trending)
                                                ...
                                                @trending(['product'=>$trending])@endtrending

                                            @endforeach
                                            @endif
                                    {{-- @include("inc.productArea")--}}
                        ...
                        <div class="product-info">
                            <div class="nav-main">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item new_cat"><a class="nav-link" data-toggle="tab" href="#woman" role="tab">Woman</a></li>
                                    <li class="nav-item new_cat"><a class="nav-link" data-toggle="tab" href="#kids" role="tab">Kids</a></li>
                                    <li class="nav-item new_cat"><a class="nav-link" data-toggle="tab" href="#accessories" role="tab">Accessories</a></li>
                                    <li class="nav-item new_cat"><a class="nav-link" data-toggle="tab" href="#essential" role="tab">Essential</a></li>
                                    <li class="nav-item new_cat"><a class="nav-link" data-toggle="tab" href="#prices" role="tab">Prices</a></li>
                                </ul>
                                <!--/ End Tab Nav -->
                            </div>
                        </div>
