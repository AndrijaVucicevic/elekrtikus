...
<aside id="sidebar_secondary" class="tabbed_sidebar ng-scope chat_sidebar">
    ...
    <div class="popup-head">
        <div class="popup-head-left pull-left"><a Design and Developmenta title="(Web Designer)" target="_blank" href="">
                <img class="md-user-image" alt="(Web Designer)" title=" (Web Designer)" src="" title=" (Web Designer)" alt="(Web Designer)">
                <h1>Vucicevic Andrija</h1><small><br> <span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span> Web Designer</small></a></div>
    ...
    <div id="chat" class="chat_box_wrapper chat_box_small chat_box_active" style="opacity: 1; display: block; transform: translateX(0px);">
        <div class="chat_box touchscroll chat_box_colors_a">
            <div class="chat_message_wrapper">
                <div class="chat_user_avatar">
                    <a href="https://web.facebook.com/iamgurdeeposahan" target="_blank" >
                        <img alt=" (Web Designer)" title="Vucicevic Andrija (Web Designer)"  src="http://www.webncc.in/images/gurdeeposahan.jpg" class="md-user-image">
                    </a>
                </div>
            ...
            <div class="chat_message_wrapper chat_message_right">
                <div class="chat_user_avatar">
                    <a href="" target="_blank" >
                        <img alt="Vucicevic Andrija (Web Designer)" title="Vucicevic Andrija (Web Designer)" src="aa" class="md-user-image">
                    </a>
                </div>
                <ul class="chat_message">
                    <li>
            ...
            <div class="chat_message_wrapper">
                <div class="chat_user_avatar">
                    <a href="" target="_blank" >
                        <img alt="Vucicevic Andrija (Web Designer)" title="Vucicevic Andrija (Web Designer)" src="http://www.webncc.in/images/gurdeeposahan.jpg" class="md-user-image">
                    </a>
                </div>
                <ul class="chat_message">
                    <li>
